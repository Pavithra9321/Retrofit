...
/**
 * Created by Mindmade technologies on 5/7/2017.
 */
    ...
    public static void justify(final TextView textView) {
        ...
        final Spannable builder = textViewText instanceof Spannable ? (Spannable) textViewText : new SpannableString(textString);
                    ...
                    for (int i = 0; i < lineCount; i++) {
                        ...
                        for (int j = 0; j < lineString.length(); j++) {
                            ...
                            if (c == ' ') {
                                ...
                                builder.setSpan(span, lineStart + j, lineStart + j + 1, Spanned.SPAN_INCLUSIVE_INCLUSIVE);
                            }
                        }
                    }
